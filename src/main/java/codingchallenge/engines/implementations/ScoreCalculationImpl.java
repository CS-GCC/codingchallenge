...
public class ScoreCalculationImpl implements ScoreCalculation {
    ...
    @Override
    public Map<String, Score> calculateScores(int questionNumber) {
        List<String> contestants = getAllContestants();
    ...
    private List<String> getAllContestants() {
        return contestantService.getAllContestantIds();
    }
